      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center justify-between gap-20">
        ...
        <div className="lg:w-1/2">
          ...
          <h2 className="font-playfair text-4xl md:text-5xl font-bold text-obsidian mb-8 leading-tight">
            Ekspor Berkelanjutan. <br/>Dampak <span className="text-emerald/80 italic">Lokal.</span>
          </h2>
          ...
          <p className="font-inter text-gray-600 text-lg leading-relaxed mb-10 font-light">
            Di Zentara, kami menerapkan prinsip Fair Trade. Kami memastikan setiap petani lokal mendapatkan kompensasi di atas rata-rata pasar, mengedukasi praktik pertanian bebas pestisida berlebih, dan menggunakan material kemasan yang ramah lingkungan melintasi samudra.
          </p>
          <div className="flex flex-wrap gap-4 pt-4 border-t border-gray-100">
            ...
            <span className="border border-gray-200 rounded-full px-6 py-2.5 font-inter text-xs font-semibold tracking-wider text-obsidian hover:border-emerald/50 transition-colors cursor-default">0% Jejak Karbon logistik (Target 2030)</span>
          </div>
        </div>
        ...
        <div className="lg:w-1/3 w-full relative flex items-center justify-center">
          ...
          >
            ...
            <p className="font-inter text-gray-500 text-sm leading-relaxed font-light">Menuju aktivitas logistik darat dan pemrosesan yang sepenuhnya netral karbon pada tahun 2030, menjamin rantai suplai masa depan.</p>
          </motion.div>
