...
export default function DirectorMessage() {
  return (
    <section className="py-32 px-6 md:px-12 lg:px-24 bg-slate-50">
      <div className="max-w-5xl mx-auto bg-white rounded-[3rem] p-8 md:p-16 shadow-xl border border-gray-100 flex flex-col md:flex-row gap-12 items-center">
        ...
        <div className="md:w-2/3">
          ...
          <h3 className="font-playfair text-2xl md:text-3xl font-bold text-obsidian mb-6 leading-relaxed">
            "Bagi kami, ekspor bukan sekadar memindahkan barang melintasi benua. Ini adalah tentang memindahkan kepercayaan."
          </h3>
          <p className="font-inter text-gray-500 mb-8 leading-relaxed">
            Kami membangun Zentara dengan satu visi utama: menjembatani kualitas alam Nusantara dengan kebutuhan absolut pasar global. Setiap kontainer yang kami kirimkan membawa reputasi perusahaan kami, dan yang lebih penting, mengamankan bisnis Anda.
          </p>
