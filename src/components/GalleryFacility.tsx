      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div>
            ...
            <h2 className="font-playfair text-4xl font-bold text-obsidian">Inside <span className="text-emerald italic">Zentara.</span></h2>
          </div>
          <p className="font-inter text-gray-500 text-sm max-w-md">
            Melihat langsung fasilitas pemrosesan dan dedikasi tim kami. Standar kebersihan dan efisiensi tingkat dunia.
          </p>
        </div>

        {/* Bento Box Grid */}
        <div className="grid grid-cols-1 md:grid-cols-3 grid-rows-[auto] gap-4 h-[600px]">
          {/* Main Big Item (Video Vibe) */}
          <motion.div 
          ...
          >
            <Image src="https://images.unsplash.com/photo-1587293852726-70cdb56c2866?q=80&w=2000&auto=format&fit=crop" alt="Warehouse" fill className="object-cover group-hover:scale-105 transition-transform duration-1000" />
          ...
          >
            <Image src="https://images.unsplash.com/photo-1611077544831-2917e7d69d21?q=80&w=1000&auto=format&fit=crop" alt="Spices" fill className="object-cover group-hover:scale-105 transition-transform duration-1000" />
            <div className="absolute inset-0 bg-gradient-to-t from-obsidian/70 to-transparent"></div>
            <div className="absolute bottom-6 left-6 text-white">
              <p className="font-playfair text-lg font-bold">Quality Control</p>
            </div>
          </motion.div>
          ...
          <motion.div 
            ...
            className="relative rounded-3xl overflow-hidden group h-[290px] md:h-auto bg-emerald p-8 flex flex-col justify-end text-white"
          >
            <div className="mb-auto">
              ...
              <p className="font-inter text-xs text-emerald-100 line-clamp-3">Semua produk mentah melewati tahapan fumigasi dan uji lab sebelum masuk kontainer ekspor.</p>
            </div>
          </motion.div>
        </div>
      </div>
